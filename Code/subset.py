...
input_dna = pd.read_csv(args.IN_FILE_PATH+'dna_seq', header=None)
input_label = pd.read_csv(args.IN_FILE_PATH+'y_label', header=None)
...
output_dna.to_csv(args.IN_FILE_PATH+'dna_seq_sub', header=False, index=False)
output_label.to_csv(args.IN_FILE_PATH+'y_label_sub', header=False, index=False)
