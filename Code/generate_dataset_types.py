...
def boundary_exon_intron_3classification(exon_boundary_set_final,exon_boundary_final,
    ...
    # optionally send these dependi ng on the dataset type
    ...
    finaldataframe = finaldf.append([dfboundary, dfexon, dfintron])
    return (sxboundary + sxexon + sxintron, syboundary + syexon + syintron)
